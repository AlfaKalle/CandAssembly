...
int main() {
    ...
    { 
        ...
        xx = (int)((boxpoints[4].x - j * 100 - 5000) / (boxpoints[4].z + 250)) + screen_center_x;
        yy = (int)((boxpoints[4].y - 4000) / (boxpoints[4].z + 250)) + screen_center_y;

        xx2 = (int)((boxpoints[6].x - j * 100 - 5000) / (boxpoints[6].z + 250)) + screen_center_x;
        yy2 = (int)((boxpoints[6].y - 4000) / (boxpoints[6].z + 250)) + screen_center_y;

        drawRectangle(buffer, xx, yy, xx2, yy2, 10);
        ...
        xx = (int)((boxpoints[0].x - j * 100 - 5000) / (boxpoints[0].z + 250)) + screen_center_x;
        yy = (int)((boxpoints[0].y - 4000) / (boxpoints[0].z + 250)) + screen_center_y;

        xx2 = (int)((boxpoints[2].x - j * 100 - 5000) / (boxpoints[2].z + 250)) + screen_center_x;
        yy2 = (int)((boxpoints[2].y - 4000) / (boxpoints[2].z + 250)) + screen_center_y;

        drawRectangle(buffer, xx, yy, xx2, yy2, 11);
